...
/**
 * 
 * @author 周梦佳 库存盘点（盘点的是当天的库存快照，包括当天的各区快递的信息（快递编号、入库日期、目的地、区号、排号、架号、位号） 。
...
public class StoreCheckUi extends JPanel {
	...
	private void initComponents() {
		...
		OK.setBounds(290, 102, 120, 40);
		cancel.setBounds(435, 102, 120, 40);
		...
		int[] list = { 40, 109, 14, 30, 20, 57, 170, 783, 500 };
