...
public class DriverManageUi extends JPanel {
	...
	private void initComponents() {
		...
		for (int i = 0; i < drivers.size(); i++) {
			String[] values = { 
					...
					drivers.get(i).getDrivingPeriod(),
					drivers.get(i).getGender() + "", 
					drivers.get(i).getIDcardNumber(),
					drivers.get(i).getPhoneNumber() 
			};
	...
	private void addListener() {
		...
		update.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				DriverVO dvo = find.findTheDriver(table.getValueAt(currentLine).get(0));
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (isAdd) {
					if (isComplete()) {
						...
						DriverVO dvo = new DriverVO(textId.getText(), textName.getText(),
								textYear.getText() + "年" + textMonth.getText() + "月" + textDay.getText() + "日",
								textCard.getText(), textMobile.getText(), textTime.getText(),
								Gender.exchange((String) comboBox.getSelectedItem()));
	...
	private boolean isComplete() {
		if (textId.equals("") || textName.equals("") || textTime.equals("") || textCard.equals("")
				|| textMobile.equals("") || textYear.equals("") || textMonth.equals("") || textDay.equals("")) {
			return false;
		} else {
			return true;
		}
