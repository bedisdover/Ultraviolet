...
public class FinancialStaffUi extends JPanel {
	...
	public FinancialStaffUi() {
		...
		button.setBounds(439, 230, 139, 47);
		add(button);
		
		JButton button_1 = new JButton("成本管理");
		button_1.setBounds(439, 307, 139, 47);
		add(button_1);
		
		JButton button_2 = new JButton("账户管理");
		button_2.setBounds(439, 391, 139, 47);
		add(button_2);
		
		JButton button_3 = new JButton("统计报表");
		button_3.setBounds(649, 267, 139, 47);
		add(button_3);
		
		JButton button_4 = new JButton("查询日志");
		button_4.setBounds(649, 356, 139, 47);
		add(button_4);
