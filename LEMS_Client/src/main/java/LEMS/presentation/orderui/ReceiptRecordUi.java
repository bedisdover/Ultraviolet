...
public class ReceiptRecordUi extends JPanel {
	...
	private static final int LOCATION_LABEL_Y=180;
	private static final int LOCATION_TEXT_X=238;
	private static final int LOCATION_TEXT_Y=185;
	...
	private void initComponents() {
		...
		labelMoney.setBounds(LOCATION_LABEL_X+13, LOCATION_LABEL_Y+140, BOUND_X, BOUND_Y);
		
		textId.setBounds(LOCATION_TEXT_X, LOCATION_TEXT_Y, BOUND_X, BOUND_Y-6);
		textMoney.setBounds(LOCATION_TEXT_X, LOCATION_TEXT_Y+140, BOUND_X, BOUND_Y-6);
		
		OK.setBounds(LOCATION_LABEL_X+15, LOCATION_LABEL_Y+275, BOUND_X-40, BOUND_Y+10);
		cancel.setBounds(LOCATION_LABEL_X+135, LOCATION_LABEL_Y+275, BOUND_X-40, BOUND_Y+10);
		...
		int[] list={40,220,14,30,20,454,125,458,480};
	...
	public void paintComponent(Graphics g) {
		...
		g.draw3DRect(110, 125, 290, 480, false);  //输入框外框
		this.repaint();
	}
